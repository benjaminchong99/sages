...
def qn_d():
    qn_d = [("frontpage", "frontpage", "frontpage"),
            ...
            "Create the ideal environment for their growth. Given nourishment, there is nothing that will not grow.",1),
            ("If a nation falls into turmoil, is it the fault of the people or the monarch?",
            "The monarch: the monarch has more than enough to live off, and experience luxuries no one else can. He should be held to the highest moral standard.",
            "The monarch: In spite of the people’s vices, the monarch has not enforced sufficient ritual and yi in his people. The people are hence not viruteous. Leading to the nation falling into turmoil", 0),
            ("When it comes to describing yourself as someone good, do you find yourself saying",
            "I am ___", 
            "I will ___", 0),
            ("How is goodness in society incited?",
            "Goodness in society requires constant and conscious interference by the governing body to produce.",
            "Goodness results from humaness, and would happen without interference.",1),
            ("What is a gentleman?",
            ...
            ("What is ritual used for?",
            "Ritual is only used to keep the temporary monarch in check, since they hold absolute moral power",
            ...
            ("Is it necessary for the king to be given luxuries?",
            "Yes! A king being given luxuries is the order of society. It is important that structure in society is maintained. ", 
            "Minimally. If the king has enough food, shelter and beauties, the king has been given enough.", 1),

...
def description():
    all_descriptions = [(
        ...
        "Governance",
        "Qns: As a parent, how would you help your child build character and moral values?,\n\nIf a nation falls into turmoil, is it the fault of the people or the monarch?,\n\nWhat are rituals used for?,\n\nIs it necessary for kings to be given luxuries?",
        """ MengZi claims “Given nourishment, there is nothing that will not grow.” [6A8] If you worry that your seedlings are not growing as well as they should be and pull them up, they will wither and possibly die. [2A2] These reflect Mengzi's belief that a good governing body provides the necessary environment while not interfering with individuals. The pro vision of necessities to the people was enough for the cultivation of the mind. """,
        """ XunZi claims that the child’s moral education must be greatly interfered with. He states that “crooked wood must await steaming and straightening on the shaping frame, and only then does it become straight.” “Blunt metal must await honing and grinding, and only then does it become sharp”. With the imagery of metal bending, likening human nature to metal, we see that Xunzi believes that discipline and rituals are necessary to reshape innate human nature. And that interference is greatly necessary in governance(chapter 23, line 20)""",
    ), (
        "Gentleman/ Ideal Man",
        "Qns: Throughout your life, how do you improve yourself as a person?,\n\nWhat is a gentleman?,\n\nIf you made a mistake or something wrong deliberately do you find yourself more often to\n\nIf you were on the death sentence for something you didn't do, and were offered a way out but to stay a criminal, would you",
        """Mengzi claims that ““It is only a gentleman who will be able to have a constant mind despite being without a constant means of livelihood.” He believed a true gentleman would not lose his morals even if he lacked necessities like food, water, or life. He claims that as a gentleman, one would uphold the values and rituals, even if at the cost of one's livelihood because such actions transcend over having a continued livelihood. (book 1A page 11)""",
        """Xunzi believed that anyone has the potential to become a gentleman as long as one is willing to commit. He stated that a gentleman constantly makes the effort to accumulate culture and continues to learn, following the ritual and yi (virtue). Comparing a petty man and a gentleman, Xunzi stated that the difference was not because of their incapability to become each other but their decision on whom they wanted to become individually. It is the choice of individuals to decide if they want to commit to becoming a gentleman or return to nature and be the petty man they originally were meant to be. (Chp 23, line 38-40), 
        \n XunZi considers the well-bred gentleman to “[conform] to the proper model as surely as though being regulated by a carpenter's ink-line” (chapter 23, lines 322-326) when arguing. Just like the well-practiced straight line that is the carpenter's ink line, Xunzi believes a well-bred gentleman is someone who is disciplined and extremely skilled in following the line. In this case, the line refers to ritual propriety in everything one does in daily life. """,
    ), (
        "Education",
...
def qn_d():
    qn_d = [("frontpage", "frontpage", "frontpage"),
            ...
            ("If a nation falls into turmoil, why would it be the fault of the monarch?",
            ...
            ("If you deliberately did a mistake or something wrong, do you find yourself more often to",
             "Feeling bad and realizing the mistake you have made.",

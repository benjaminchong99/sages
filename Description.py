...
def description():
    all_descriptions = [(
        ...
        """ MengZi claims “Given nourishment, there is nothing that will not grow.” [6A8] If you worry that your seedlings are not growing as well as they should be and pull them up, they will wither and possibly die. [2A2] These reflect Mengzi's belief that a good governing body provides the necessary environment while not interfering with individuals. The provision of necessities to the people was enough for the cultivation of the mind. """,
